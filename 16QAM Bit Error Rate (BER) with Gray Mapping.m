% Digital Communications Systems (3C) - Assignment - 16QAM Bit Error Rate (BER) with Gray Mapping
...
ther_BER = (3/(2*k))*erfc(sqrt(k*0.1*(10.^(Eb_N0_dB/10))));

close all
figure
semilogy(Eb_N0_dB,ther_BER,'bs-','LineWidth',2);
hold on
semilogy(Eb_N0_dB,BER_sim,'mx-','LineWidth',2);
axis([0 15 10^-5 1])
grid on
